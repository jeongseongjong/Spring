...
<body>
	<div class="container">
		...
		<div class="menu1">
			<a href="${rootPath}/tour/curlist?code=${AREALIST[0].code}"><img src="${rootPath}/img/${AREALIST[0].name}.png"></a> <a href="${rootPath}/tour/curlist?code=${AREALIST[8].code}"><img src="${rootPath}/img/${AREALIST[8].name}.png"></a> <a href="${rootPath}/tour/curlist?code=${AREALIST[9].code}"><img src="${rootPath}/img/${AREALIST[9].name}.png"></a> <a
				href="${rootPath}/tour/curlist?code=${AREALIST[10].code}"
			><img src="${rootPath}/img/${AREALIST[10].name}.png"></a> <a href="${rootPath}/tour/curlist?code=${AREALIST[11].code}"><img src="${rootPath}/img/${AREALIST[11].name}.png"></a> <a href="${rootPath}/tour/curlist?code=${AREALIST[12].code}"><img src="${rootPath}/img/${AREALIST[12].name}.png"></a> <a href="${rootPath}/tour/curlist?code=${AREALIST[13].code}"><img
				src="${rootPath}/img/${AREALIST[13].name}.png"
			></a> <a href="${rootPath}/tour/curlist?code=${AREALIST[14].code}"><img src="${rootPath}/img/${AREALIST[14].name}.png"></a> <a href="${rootPath}/tour/curlist?code=${AREALIST[15].code}"><img src="${rootPath}/img/${AREALIST[15].name}.png"></a> <a href="${rootPath}/tour/curlist?code=${AREALIST[16].code}"><img src="${rootPath}/img/${AREALIST[16].name}.png"></a>
