...
public class ProductController {
	...
	public String getPlist(
			Model model,
			@RequestParam(value="search", required=false, defaultValue="1") String p_name,
		...
		// 객체의 이름과 같은 문자열로 자동지정이 된다.
		// model.addAttribute("pageDTO", pageDTO);e
	...
	public String input(
		...
		try {
			...
			log.debug("대표 이미지 업로드 오류 : " + e.getMessage());
		}
