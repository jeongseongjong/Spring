...
<link rel="stylesheet"
	href="${rootPath}/css/pro-main.css?ver=2019-12-24-001">
<script>
	var rootPath = "${rootPath}"
	var bStart = 0
</script>
<script src="${rootPath}/js/pro-main.js?ver=?2019-12-24"></script>
</head>
<body>
				...
				<form class="was-validated" method="POST"
					...
					<div class="form-group">
						<label for="p_code">상품코드:</label> <input type="text"
							class="form-control" placeholder="상품코드를 입력하라" name="p_code"
							id="p_code">
					</div>
					...
					<div class="form-group">
						<label>보조이미지</label>
						<!-- type이 file인 경우에는 file을 업로드할 경우 사용 -->
						<input type="file" class="form-controller" name="u_files"
							multiple="multiple" accept="image/* " id="u_files">
					</div>

					<div class="form-group main-img-box">
						<img src="${rootPath}/files/noimage.png" id="p_image" width="50%">
						<div class="img-menu" >
