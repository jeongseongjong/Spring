...
<link href="${rootPath}/css/top-scroll.css?ver=20191128002" rel="stylesheet" type="text/css">
					...
					<c:otherwise>
						...
						<% 
							/*
								...
								ex) data-id, data-name, data-num data-addr

								이 사용자 정의형 속성은 JS, jQ에서 참조할 수 있다.
							*/							
						%>
