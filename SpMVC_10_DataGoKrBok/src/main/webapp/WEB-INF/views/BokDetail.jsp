...
<p>문의처명 : ${detail.inqplCtadrList.servSeDetailNm}
			 (${detail.inqplCtadrList.servSeDetailLink})

<p>관련 사이트 : <a href="${detail.inqplHmpgReldList.servSeDetailLink}">
				${detail.inqplHmpgReldList.servSeDetailNm}</a>

<p>서식/자료 : <a href="${detail.basfrmList.servSeDetailLink}">
				 ${detail.basfrmList.servSeDetailNm}</a>

<p>근거법령 : <a href="${detail.baslawList.servSeDetailLink}">
